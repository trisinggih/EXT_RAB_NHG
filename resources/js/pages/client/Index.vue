...
onMounted(async () => {
  if (!clients.value.length) {
    try {
      const res = await axios.get(route('blogs.index'))
...
const source = computed(() => clients.value)

const handleClientDeletion = (clientID: number) => {
    if (confirm('Are you sure you want to delete this role?')) {
        router.delete(route('clients.destroy', { id: clientID }), {
            preserveScroll: true,
            onSuccess: () => {
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex items-center gap-2">
            ...
            <Link :href="route('clients.create')">
              <button class=" btn bg-primary p-2 text-white rounded ml-2">Tambah Client</button>
            </Link>
        </div>
        ...
        <table class="w-full text-sm">
            ...
            <tr class="text-gray-700">
                ...
                <th class="px-4 py-3 border-b border-gray-200 text-left">Action</th>
            </tr>
            </thead>
            <tbody>
            <tr
                ...
                <td class="px-4 py-3 border-b border-gray-200 whitespace-nowrap">
                    <div class="flex gap-1">
                        <Link :href="route('clients.edit', {id: u.id})">
                        ...
                        <Button class="bg-red-600 text-white" @click="handleClientDeletion(u.id)">
