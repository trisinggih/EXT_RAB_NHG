...
const props = defineProps({
  blogs: { type: Object, default: null }
})
...
const source = computed(() => blogs.value)

const handleBlogDeletion = (roleID: number) => {
    if (confirm('Are you sure you want to delete this blog??')) {
        router.delete(route('blogs.destroy', {id: roleID}));
    }
}
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex items-center gap-2">
            ...
            <Link :href="route('blogs.create')">
              <button class=" btn bg-primary p-2 text-white rounded ml-2">Tambah Blog</button>
            </Link>
        ...
        <table class="w-full text-sm">
            ...
            >
                ...
                <td class="px-4 py-3 border-b border-gray-200 whitespace-nowrap font-medium text-gray-800">{{ u.title_blog }}</td>
                <td class="px-4 py-3 border-b border-gray-200 whitespace-nowrap">
                  <img :src="`/images/${u.image_blog}`" class="w-[100px]" /></td>
                <td class="px-4 py-3 border-b border-gray-200 whitespace-nowrap">{{ u.description_blog ?? '-' }}</td>
                <td class="px-4 py-3 border-b border-gray-200 whitespace-nowrap">
                    <div class="flex gap-1">
                        <Link :href="route('blogs.edit', {id: u.id})">
                        ...
                        <Button class="bg-red-600 text-white" @click="handleBlogDeletion(u.id)">
